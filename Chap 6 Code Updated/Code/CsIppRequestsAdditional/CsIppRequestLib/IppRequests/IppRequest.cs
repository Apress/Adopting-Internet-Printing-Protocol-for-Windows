...
namespace CsIppRequestLib
{
    public abstract class IppRequest
    {
        ...
        private void MakeOperationAttributes(string printerUri)
        {
            ...
            m_bRequestingUserName = RequestHelpers.CreatePrinterAttribute(0x42, "requesting-user-name", Environment.UserName);
        }
        ...
        protected async Task<CompletionStruct> SendIppRequestAsync(RequestType type)
        {
            ...
            using (var cts = new CancellationTokenSource(TimeSpan.FromSeconds(30)))
            {
                ...
                try
                {
                    ...
                    return await GetIppResponseAsync(type, response, cts.Token);
                }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        protected async Task<CompletionStruct> GetIppResponseAsync(RequestType type, HttpResponseMessage response, CancellationToken ct = default)
        {
            CompletionStruct cs;
