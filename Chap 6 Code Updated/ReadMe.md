...
Note: To debug the recursive calls, I had to open Debug Options in Visual Studio for the project and enable “Suppress JIT optimization on module load (Managed only)”.
>>>>>>> 5a8c1387880bca4f0a5a38e8eca2e122b8af9af3
